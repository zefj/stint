...
```typescript
export const deleteSessionCommand = new Command('delete-session')
...
12. [ ] Add `stint delete-session <session-id>` command
...
- [ ] `stint delete-session <id>` removes session with confirmation
